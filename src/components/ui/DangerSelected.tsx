    ...
    <div className="relative bg-gray-50 h-screen flex flex-col justify-between">
      <div className="flex-grow pt-8 px-4">
        <div className="text-center">
          <h4 className="inline-block bg-white border-2 font-semibold py-2 px-6 rounded-full shadow-sm font-family-franklin">
            Marca el área en el mapa
          </h4>
        </div>
      </div>
      ...
      <div className="bg-white w-full rounded-t-3xl shadow-lg p-6 border-1 border-gray-300">
        ...
        <p className="text-center text-lg mb-8 font-family-franklin">
