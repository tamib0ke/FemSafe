      ...
      />
        ...
        <div className="flex flex-col gap-10 mt-10 m-6">
            ...
            <div className="flex items-center gap-3  mb-2">
                ...
                <h3 className="text-texto-violeta font-bold text-xl ">Qué es FemSafe?</h3>
            </div>
            <p className="text-sm text-black-text border border-gray-300 rounded-lg p-4 transition-colors duration-300 hover:bg-purple-2">
        ...
        <div >
          <div className="flex items-center gap-3  mb-2">
            ...
            <h3 className="text-texto-violeta font-bold text-xl ">Mapa Interactivo</h3>
          </div>
          <ul className="list-disc list-inside text-sm text-black-text space-y-1 border border-gray-300 rounded-lg p-4 transition-colors duration-300 hover:bg-purple-2">
