    ...
    return(
        <div className="h-screen  bg-white  relative flex flex-col font-family-franklin">
            ...
            <div className="bg-purple text-white px-4 py-3 flex justify-between items-center">
                ...
                <span className=" font-bold">FemSafe</span>
                </div>
                <button className="mr-3" ><img src="./src/assets/Equis.png" alt=""/></button>
            </div>
            ...
            <nav className="flex flex-col gap-5 p-3 font-bold text-xl text-black-text  ">
                <a href="#" className="flex items-center gap-3 py-2 hover:bg-purple-2 hover:text-white">
